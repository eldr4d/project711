...
try:
  cur.execute("CREATE INDEX src_index_coloc ON colocations (src);")
  cur.execute("CREATE INDEX dest_index_coloc ON colocations (dest);")
  cur.execute("CREATE INDEX src_dest_index_coloc ON colocations (src, dest);")
